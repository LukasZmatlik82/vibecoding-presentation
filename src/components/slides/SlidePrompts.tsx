...
export function SlidePrompts() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-[1] flex min-h-0 flex-1 flex-col rounded-2xl border border-cyan-500/35 bg-white/5 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06)] backdrop-blur-md">
          ...
          <button
            ...
            className={cn(
              ...
              copied
                ...
                : 'border-cyan-500/50 bg-gradient-to-r from-cyan-500/20 to-fuchsia-500/20 text-white shadow-[0_0_20px_-6px_rgba(34,211,238,0.5)] hover:from-cyan-500/30 hover:to-fuchsia-500/25',
            )}
          >
            {copied ? (
              <>
              ...
              <>
                <ClipboardCopy className="h-4 w-4 text-cyan-300" aria-hidden />
                Copy to clipboard
              </>
            )}
          </button>
        ...
        <div className="min-h-0 flex-1 p-4 sm:p-5">
          ...
          <textarea
            ...
            spellCheck={false}
            className="h-[min(58vh,520px)] w-full resize-none rounded-xl border border-white/10 bg-slate-950/50 px-4 py-3 font-mono text-xs leading-relaxed text-slate-200 shadow-inner outline-none ring-cyan-500/20 focus-visible:ring-2 sm:text-sm"
          />
        </div>
      </div>
