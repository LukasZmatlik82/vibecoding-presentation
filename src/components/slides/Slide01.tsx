  ...
  return (
    ...
    >
      ...
      <div className="relative z-[1] mx-auto mb-8 max-w-4xl text-center">
        ...
        <p className="animate-fade-in-delay-3 mt-4 text-left text-sm leading-relaxed text-slate-100 sm:text-center sm:text-[0.95rem]">
          <span className="font-medium text-slate-100">The Definition: </span>
      ...
      >
        ...
        >
          <div>
            <div
              className={cn(
                'mb-3 flex h-10 w-10 items-center justify-center rounded-lg border sm:mb-4 sm:h-11 sm:w-11',
                'border-pink-500/45 bg-pink-500/10',
              )}
            >
              <Terminal className="h-5 w-5 text-pink-400" aria-hidden />
            </div>
            <p className="font-mono text-2xl font-bold tracking-tight text-pink-300 sm:text-3xl lg:text-[1.65rem]">
              SYNTAX
            </p>
            <h3 className="mt-1.5 text-sm font-semibold text-slate-100 sm:mt-2 sm:text-base">
        ...
        >
          <div>
            <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-lg border border-cyan-400/45 bg-white/10 sm:mb-4 sm:h-11 sm:w-11">
